...
def crossoff_movie():
    ...
    # sentence = crossed_off_movie + " has been crossed off your Watchlist!"
    # content = page_header + "<p>" + sentence + "</p>" + page_footer
    # return content
    return page_header + '<p>' + '<strike>' + crossed_off_movie + '</strike>' + ' has been crossed off from your watchlist!' + '</p>' + page_footer   
